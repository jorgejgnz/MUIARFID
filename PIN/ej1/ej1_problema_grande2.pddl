(define (problem ej1_problema_grande2)
...
(:objects
    ...
    M1 M2 - maquina
    E1 E2 E3 E4 E5 E6 E7 E8 E9 E10 - equipaje
    N1 N2 - numero
)
...
(:init
	...
	(notdanger E7)
    (destination E7 P4)
    (waiting E7 ZonaFacturacion)
	
	(notdanger E8)
    (destination E8 P4)
    (waiting E8 ZonaFacturacion)
	
	(notdanger E9)
    (destination E9 P8)
    (waiting E9 ZonaFacturacion)
	
	(notdanger E10)
    (destination E10 P8)
    (waiting E10 ZonaFacturacion)
